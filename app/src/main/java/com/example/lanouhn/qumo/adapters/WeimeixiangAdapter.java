 ...
 */
public class WeimeixiangAdapter extends RecyclerView.Adapter<WeimeixiangAdapter.viewholder> {

    private Context context;
    List<Weimeistl> list;//实体类
    private GoddesInterface godesspicClick;//定义的接口
    //构造器
    public WeimeixiangAdapter(GoddesInterface godesspicClick) {
    ...
    public WeimeixiangAdapter(Context context, List<Weimeistl> list) {
    ...
    public viewholder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.weimeixiang_item,null);
